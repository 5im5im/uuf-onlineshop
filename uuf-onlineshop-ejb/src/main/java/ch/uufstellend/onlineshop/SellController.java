...
import ch.uufstellend.onlineshop.model.Item;
...
public class SellController implements Serializable {
    ...
    private final static Logger LOGGER = Logger.getLogger(SigninController.class.toString());
